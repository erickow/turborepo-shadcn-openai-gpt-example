# Turborepo starter with shadcn openai chat GPT Example
...
```sh
git clone https://github.com/erickow/turborepo-shadcn-openai-gpt-example.git
```
...
- [template turborepo shadcn starter](https://github.com/dan5py/turborepo-shadcn-ui.git)
